...
function EyeToggle({ field, showPwd, setShowPwd }) {
  return (
    <button
      type="button"
          ...
          <form onSubmit={handlePasswordChange} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                ...
                />
                <EyeToggle field="current" showPwd={showPwd} setShowPwd={setShowPwd} />
              </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                ...
                />
                <EyeToggle field="confirm" showPwd={showPwd} setShowPwd={setShowPwd} />
              </div>
